...
class MltCanvas:
    ...
    def draw_barv(self, x_data, y_data, sub_canvas_id=1, color="#2196F3", width=0.35):
        ax = self.add_canvas(sub_canvas_id)
        ax.bar(x_data, y_data, align='center', color=color, width=width)
        # ax.hist(x_data, y_data, facecolor=color)
